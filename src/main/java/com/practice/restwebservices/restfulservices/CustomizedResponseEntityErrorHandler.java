package com.practice.restwebservices.restfulservices;

import com.practice.restwebservices.restfulservices.helloworld.ErrorDetails;
...
class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(),
                "Current error count is " + ex.getErrorCount() + " First error is "
